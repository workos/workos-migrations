...
export async function runExport(state) {
...
async function runClerkTransform(state) {
    ...
    try {
        ...
        console.error(chalk.red(`\n  Clerk transform failed: ${err.message}`));
        state.cancelled = true;
    }
    return state;
}
async function runFirebaseTransform(state) {
    ...
    try {
        ...
        console.error(chalk.red(`\n  Firebase transform failed: ${err.message}`));
        state.cancelled = true;
    }
    return state;
}
async function runCognitoExport(state) {
    ...
    try {
        ...
        const outputFiles = result.entities.output_files;
        ...
        console.error(chalk.red(`\n  Cognito export failed: ${err.message}`));
