...
export const UPLOAD_ORGANIZATION_CSV_HEADERS = ['organization_id', 'name'] as const;

export const UPLOAD_ORGANIZATION_MEMBERSHIP_CSV_HEADERS = ['organization_id', 'user_id'] as const;
