...
import { registerExportSupabaseCommand } from './commands/export-supabase.js';
import { registerMergePasswordsCommand } from './commands/merge-passwords.js';
import { registerMergePasswordsSupabaseCommand } from './commands/merge-passwords-supabase.js';
...
registerExportSupabaseCommand(program);
registerMergePasswordsCommand(program);
registerMergePasswordsSupabaseCommand(program);
